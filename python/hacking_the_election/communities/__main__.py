...
Usage:
python3 -m hacking_the_election.communities <serialized_state_graph_path> <n_communities> [animation_dir]
"""
...
if __name__ == "__main__":
    ...
    animation_dir = None
    if len(sys.argv) > 3:
        animation_dir = sys.argv[3]

    generate_communities(precinct_graph, int(sys.argv[2]), animation_dir)